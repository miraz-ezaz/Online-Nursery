...
<nav class="navbar navbar-expand-lg navbar-light custom-bg">
    <div class ="container">
        <a class="navbar-brand" href="index.jsp">Plant Shop</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" data-toggle="modal" data-target="#cart" href="#"> <i class="fa fa-cart-plus" style="font-size: 25px"></i><span class="ml-0 cart-items" style="font-size: 20px"> ( 0 )</span></a>
                </li> 
