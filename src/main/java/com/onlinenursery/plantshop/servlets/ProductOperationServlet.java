...
import com.onlinenursery.plantshop.dao.CategoryDao;
import com.onlinenursery.plantshop.dao.ProductDao;
import com.onlinenursery.plantshop.entities.Category;
import com.onlinenursery.plantshop.entities.Product;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (op.trim().equals("addcategory")) {
                ...
                String descriptin = request.getParameter("catDescription");

                Category category = new Category();
                category.setCategoryTittle(title);
                category.setCategoryDescription(descriptin);
